...
namespace GenieClient.Genie
{
    public class Config
    {
        ...
        public string sConnectString = "FE:GENIE /VERSION:" + Genie4Lib.MyResources.GetApplicationVersion() + " /P:WIN_XP /XML";
        ...
        public string LogDir
        {
            get
            {
                ...
                {
                    sLog = LocalDirectory.Path;
                    if (sLogDir.StartsWith(@"\") || sLog.EndsWith(@"\"))
                    {
                        sLog += sLogDir;
                    }
                    else
