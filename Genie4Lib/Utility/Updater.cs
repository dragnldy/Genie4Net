...
namespace GenieClient
{
    public static class Updater
    {
        ...
        public static string LocalClientVersion
        {
            get
            {
                return MyResources.GetApplicationVersion();
                //string appName = MyResources.GetApplicationName() + ".exe";
                //var localClientPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, appName);
                //FileVersionInfo fileVersionInfo = File.Exists(localClientPath) ? FileVersionInfo.GetVersionInfo(localClientPath) : null;
