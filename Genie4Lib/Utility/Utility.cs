...
namespace GenieClient
{
    ...
    /// <returns>File.GetLastWriteTime, or DateTime.MaxValue if exception was encountered.</returns>
        ...
        public static string AssemblyDescription(System.Reflection.Assembly a)
        {
            // Try to retrieve the AssemblyDescriptionAttribute
            AssemblyDescriptionAttribute descriptionAttribute =
                (AssemblyDescriptionAttribute)Attribute.GetCustomAttribute(a, typeof(AssemblyDescriptionAttribute));

            return descriptionAttribute != null ? descriptionAttribute.Description : "No description available";
        }
        public static string AssemblyCopyright(System.Reflection.Assembly a)
        {
            return a.GetCustomAttributes(typeof(System.Reflection.AssemblyCopyrightAttribute), false)?.FirstOrDefault()?.ToString() ?? string.Empty;
        }
