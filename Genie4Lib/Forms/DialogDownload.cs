...
namespace GenieClient
{
    public partial class DialogDownload
    {
        ...
        private void DialogDownload_Load(object sender, EventArgs e)
        {
            ...
            LabelFile.Text = "";
            LabelSpeed.Text = "";
            LabelNewVersion.Text = "An update is available for Genie!" + System.Environment.NewLine + System.Environment.NewLine + 
                "Your Version: " + Genie4Lib.MyResources.GetApplicationVersion() + System.Environment.NewLine + "Update Version: " + strUpdateString + System.Environment.NewLine;
