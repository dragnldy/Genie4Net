...
namespace GenieClient
{
    public partial class FormSkin : Form
    {
        ...
        {
            oTopLeft = GetResourceBitmap("skin_topleft");
            oTopRight = GetResourceBitmap("skin_topright");
            oTop = GetResourceBitmap("skin_top");
            oLeft = GetResourceBitmap("skin_left");
            oRight = GetResourceBitmap("skin_right");
            oBottom = GetResourceBitmap("skin_bottom");
            oBottomLeft = GetResourceBitmap("skin_bottomleft");
            oBottomRight = GetResourceBitmap("skin_bottomright");
        ...
        private Bitmap GetResourceBitmap(string sRef)
        {
            try
            {
                var bitmap = Genie4Lib.MyResources.ImageResource(sRef);
