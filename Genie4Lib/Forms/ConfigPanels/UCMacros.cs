...
namespace GenieClient
{
    public partial class UCMacros
    {
        ...
        {
            DialogEdit dEdit = (DialogEdit)Genie4Lib.MyResources.FormResource(ProductName + ".DialogEdit", true);
            if (dEdit != null)
            {
                dEdit.Text = TextBoxAction.Text;
                if (dEdit.ShowDialog() == DialogResult.OK)
                {
                    TextBoxAction.Text = dEdit.EditText;
                }
            }
        }
    }
