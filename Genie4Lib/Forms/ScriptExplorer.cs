...
#pragma warning restore CS0168
        ...
        private void ToolStripButtonNew_Click(object sender, EventArgs e)
        {
            ...
            DialogScriptName dScript = Genie4Lib.MyResources.FormResource("DialogScriptName", true) as DialogScriptName;

            if (dScript.ShowDialog(Parent) == DialogResult.OK)
            {
                string scriptName = dScript.ScriptName;
           ...
           dScript.ScriptName = string.Empty;
        }
